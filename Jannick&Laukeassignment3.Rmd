...
boxplot(csfi, main = "Computer Simulated Flight Instruction", ylab = "Test score"); boxplot(tfi, main = "Traditional Flight Instructions", ylab = "Test score") #create boxplots for both groups. These are used to check outliers
```
